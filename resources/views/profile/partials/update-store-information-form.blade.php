<section>
    ...
    <form method="post" action="{{ route('store.update') }}" class="mt-6 space-y-6">
        ...
        @if (Auth::user()->role == 'kasir')
            <div>
                ...
                <x-text-input id="store_name" name="store_name" type="text" class="mt-1 block w-full" :value="old('store_name', $store->store_name)"
                    required autofocus autocomplete="store_name" readonly />
                <x-input-error class="mt-2" :messages="$errors->get('store_name')" />
            </div>

            <div>
                <x-input-label for="store_address" :value="__('Store Address')" />
                <x-text-input id="store_address" name="store_address" type="text" class="mt-1 block w-full"
                    :value="old('store_address', $store->store_address)" required autofocus autocomplete="store_address" readonly />
        ...
        @else
            <div>
                ...
                <x-text-input id="store_name" name="store_name" type="text" class="mt-1 block w-full"
                    :value="old('store_name', $store->store_name)" required autofocus autocomplete="store_name" />
                <x-input-error class="mt-2" :messages="$errors->get('store_name')" />
            </div>
            ...
            <div>
                <x-input-label for="store_address" :value="__('Store Address')" />
                <x-text-input id="store_address" name="store_address" type="text" class="mt-1 block w-full"
                    :value="old('store_address', $store->store_address)" required autofocus autocomplete="store_address" />
                <x-input-error class="mt-2" :messages="$errors->get('store_address')" />
            </div>
        @endif
        ...
        <div>
            ...
            <x-text-input id="created_at" name="created_at" type="text" class="mt-1 block w-full" :value="$store->created_at->format('Y-m-d H:i:s')"
                readonly />
        ...
        <div>
            ...
            <x-text-input id="updated_at" name="updated_at" type="text" class="mt-1 block w-full" :value="$store->updated_at->format('Y-m-d H:i:s')"
                readonly />
