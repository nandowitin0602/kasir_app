                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.update', $user) }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                <x-input-label for="username" :value="__('Username')" class="col-sm-2 col-form-label text-nowrap" />
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <x-input-label for="name" :value="__('Name')" class="col-sm-2 col-form-label text-nowrap" />
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <x-input-label for="email" :value="__('Email')" class="col-sm-2 col-form-label text-nowrap" />
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <x-input-label for="address" :value="__('Address')" class="col-sm-2 col-form-label text-nowrap" />
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <x-input-label for="contact" :value="__('Contact')" class="col-sm-2 col-form-label text-nowrap" />
                                <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col-sm-12 d-flex justify-content-center gap-1">
                                    <a class="btn btn-danger" href="{{ route('user.index') }}" style="width: 100px;">Back</a>
                                    <button type="submit" class="btn btn-info" style="width: 100px;">Edit User</button>
                                </div>
                            </div>
                        </form>
